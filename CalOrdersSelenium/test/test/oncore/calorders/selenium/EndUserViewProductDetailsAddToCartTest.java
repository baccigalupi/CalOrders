...
public class EndUserViewProductDetailsAddToCartTest {
  ...
  @Test
  public void testEndUserViewProductDetailsAddToCart() throws Exception {
    ...
    driver.findElement(By.id("productImage1")).click();

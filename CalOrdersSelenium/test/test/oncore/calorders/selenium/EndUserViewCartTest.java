...
public class EndUserViewCartTest {
  ...
  @Test
  public void testEndUserViewCart() throws Exception {
    ...
    driver.findElement(By.xpath("(//button[@id='addToCart'])[2]")).click();
    driver.findElement(By.id("continueShopping")).click();
    driver.findElement(By.xpath("(//button[@id='addToCart'])[3]")).click();
    driver.findElement(By.id("cart")).click();
    driver.findElement(By.xpath("(//button[@id='continueShopping'])[2]")).click();
  }

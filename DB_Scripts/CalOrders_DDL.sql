...
CREATE INDEX `fk_ORDER_USER1_idx` ON `calordersdb`.`ORDER` (`PTY_UID_FK` ASC);
...
CREATE INDEX `fk_ADDRESS_EMPLOYEES1_idx` ON `calordersdb`.`ADDRESS` (`PTY_UID_FK` ASC);
...
CREATE INDEX `fk_EMPLOYEE_CONTACT_EMPLOYEES_idx` ON `calordersdb`.`CONTACT` (`PTY_UID_FK` ASC);
...
CREATE INDEX `fk_GROUP_EMPLOYEE_ASSOC_EMPLOYEES1_idx` ON `calordersdb`.`GROUP_PARTY_ASSOC` (`PTY_UID_FK` ASC);

CREATE INDEX `fk_GROUP_EMPLOYEE_ASSOC_GROUPS1_idx` ON `calordersdb`.`GROUP_PARTY_ASSOC` (`GRP_UID_FK` ASC);

...
CREATE UNIQUE INDEX `CMP_UID_UNIQUE` ON `calordersdb`.`DEPARTMENT` (`DEP_UID` ASC);
...
-- -----------------------------------------------------
-- Table `calordersdb`.`GROUP`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calordersdb`.`GROUP` ;

CREATE TABLE IF NOT EXISTS `calordersdb`.`GROUP` (
...
CREATE UNIQUE INDEX `GRP_UID_UNIQUE` ON `calordersdb`.`GROUP` (`GRP_UID` ASC);

CREATE INDEX `fk_GROUPS_Company1_idx` ON `calordersdb`.`GROUP` (`DEP_UID_FK` ASC);

CREATE INDEX `fk_GROUPS_GRP_TYPE_CD1_idx` ON `calordersdb`.`GROUP` (`GRP_TYPE_CD` ASC);
...
CREATE TABLE IF NOT EXISTS `calordersdb`.`PRIVILEGE` (
  ...
  CONSTRAINT `fk_PRIVILEGES_GROUPS`
    ...
    REFERENCES `calordersdb`.`GROUP` (`GRP_UID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `calordersdb`.`ORD_TYPE_CD`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calordersdb`.`ORD_TYPE_CD` ;

CREATE TABLE IF NOT EXISTS `calordersdb`.`ORD_TYPE_CD` (
  `CODE` CHAR(4) NOT NULL,
  `SHORT_DESC` VARCHAR(64) NOT NULL,
  `LONG_DESC` VARCHAR(128) NOT NULL,
  `CREATE_USER_ID` VARCHAR(32) NOT NULL,
...
-- -----------------------------------------------------
-- Table `calordersdb`.`USER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calordersdb`.`USER` ;

CREATE TABLE IF NOT EXISTS `calordersdb`.`USER` (
  `USR_UID` INT(11) NOT NULL AUTO_INCREMENT,
  `USR_USER_ID` VARCHAR(32) NOT NULL,
  `USR_PASSWORD` VARCHAR(256) NOT NULL,
  `USR_FIRST_NM` VARCHAR(45) NOT NULL,
  `USR_MID_NM` VARCHAR(45) NULL,
  `USR_LAST_NM` VARCHAR(45) NOT NULL,
  `USR_TITLE` VARCHAR(45) NULL,
  `USR_HIRE_DT` DATETIME NOT NULL,
  `USR_ID` VARCHAR(128) NOT NULL,
  `USR_IMG_ID` VARCHAR(512) NULL,
  `USR_ACTIVE_IND` INT NOT NULL DEFAULT 1,
  `USR_DOB_DT` DATETIME NULL,
  `CREATE_USER_ID` VARCHAR(32) NOT NULL,
  `CREATE_TS` DATETIME NOT NULL,
  `UPDATE_USER_ID` VARCHAR(32) NOT NULL,
  `UPDATE_TS` DATETIME NOT NULL,
...
CREATE UNIQUE INDEX `EMP_UID_UNIQUE` ON `calordersdb`.`USER` (`USR_UID` ASC);

CREATE UNIQUE INDEX `EMP_USER_ID_UNIQUE` ON `calordersdb`.`USER` (`USR_USER_ID` ASC);


-- -----------------------------------------------------
-- Table `calordersdb`.`ORDER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calordersdb`.`ORDER` ;

CREATE TABLE IF NOT EXISTS `calordersdb`.`ORDER` (
  `ORD_UID` INT NOT NULL AUTO_INCREMENT,
  `USR_UID_FK` INT(11) NOT NULL,
  `ORD_TYPE_CD` CHAR(4) NOT NULL,
  ...
  `UPDATE_TS` DATETIME NOT NULL,
  PRIMARY KEY (`ORD_UID`),
  CONSTRAINT `fk_ORDER_ORD_TYPE_CD1`
    FOREIGN KEY (`ORD_TYPE_CD`)
    REFERENCES `calordersdb`.`ORD_TYPE_CD` (`CODE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_ORDER_USER1`
    ...
    REFERENCES `calordersdb`.`USER` (`USR_UID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE UNIQUE INDEX `ORD_UID_UNIQUE` ON `calordersdb`.`ORDER` (`ORD_UID` ASC);

CREATE INDEX `fk_ORDER_ORD_TYPE_CD1_idx` ON `calordersdb`.`ORDER` (`ORD_TYPE_CD` ASC);

CREATE INDEX `fk_ORDER_ORD_STATUS_CD1_idx` ON `calordersdb`.`ORDER` (`ORD_STATUS_CD` ASC);

CREATE INDEX `fk_ORDER_USER1_idx` ON `calordersdb`.`ORDER` (`USR_UID_FK` ASC);
...
CREATE TABLE IF NOT EXISTS `calordersdb`.`PRD_REL_SERVICE` (
  ...
  `PRS_SHORT_DESC` VARCHAR(64) NOT NULL,
  `PRS_LONG_DESC` VARCHAR(128) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `calordersdb`.`ORDER_PRODUCT_ASSOC` (
  ...
  CONSTRAINT `fk_ORDER_PRODUCT_ASSOC_ORDER1`
    ...
    REFERENCES `calordersdb`.`ORDER` (`ORD_UID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_ADDRESS_EMPLOYEES1_idx` ON `calordersdb`.`ADDRESS` (`EMP_UID_FK` ASC);

CREATE INDEX `fk_ADDRESS_COMPANY1_idx` ON `calordersdb`.`ADDRESS` (`DEP_UID_FK` ASC);
...
-- -----------------------------------------------------
-- Table `calordersdb`.`CONTACT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calordersdb`.`CONTACT` ;

CREATE TABLE IF NOT EXISTS `calordersdb`.`CONTACT` (
  `EMC_UID` INT(11) NOT NULL AUTO_INCREMENT,
  `USR_UID_FK` INT(11) NULL,
  `DEP_UID_FK` INT(11) NULL,
  ...
  CONSTRAINT `fk_EMC_TYPE_CD`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EMPLOYEE_CONTACT_EMPLOYEES`
    FOREIGN KEY (`USR_UID_FK`)
    REFERENCES `calordersdb`.`USER` (`USR_UID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE INDEX `fk_EMPLOYEE_CONTACT_EMPLOYEES_idx` ON `calordersdb`.`CONTACT` (`USR_UID_FK` ASC);

CREATE INDEX `fk_CONTACT_COMPANY1_idx` ON `calordersdb`.`CONTACT` (`DEP_UID_FK` ASC);

CREATE INDEX `fk_EMC_TYPE_CD_idx` ON `calordersdb`.`CONTACT` (`EMC_TYPE_CD` ASC);


-- -----------------------------------------------------
-- Table `calordersdb`.`GROUP_USER_ASSOC`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `calordersdb`.`GROUP_USER_ASSOC` ;

CREATE TABLE IF NOT EXISTS `calordersdb`.`GROUP_USER_ASSOC` (
  ...
  `UPDATE_TS` DATETIME NOT NULL,
  PRIMARY KEY (`GRE_UID`),
  CONSTRAINT `fk_GROUP_EMPLOYEE_ASSOC_EMPLOYEES1`
    FOREIGN KEY (`USR_UID_FK`)
    REFERENCES `calordersdb`.`USER` (`USR_UID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_GROUP_EMPLOYEE_ASSOC_GROUPS1`
    FOREIGN KEY (`GRP_UID_FK`)
    REFERENCES `calordersdb`.`GROUP` (`GRP_UID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE UNIQUE INDEX `GRE_UID_UNIQUE` ON `calordersdb`.`GROUP_USER_ASSOC` (`GRE_UID` ASC);

CREATE INDEX `fk_GROUP_EMPLOYEE_ASSOC_EMPLOYEES1_idx` ON `calordersdb`.`GROUP_USER_ASSOC` (`USR_UID_FK` ASC);

CREATE INDEX `fk_GROUP_EMPLOYEE_ASSOC_GROUPS1_idx` ON `calordersdb`.`GROUP_USER_ASSOC` (`GRP_UID_FK` ASC);

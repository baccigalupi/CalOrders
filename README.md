...
m. Deployed the prototype on an Infrastructure as a Service (IaaS) or Platform as Service(PaaS) provider, and indicated which provider they used | We deployed the prototype to the Azure PaaS provider, please see sections 4 and 5 of the [DevOps Wiki] (https://github.com/OncoreLLC/CalOrders/wiki/Environments) for details.
